...
Una vez definidos todos los elementos que participan en la modificaci'on de la plataforma rob'otica, es necesario de indicar c'omo se conectan entre ellos. En este proyecto se han diferenciado cuatro conexionados: Conexionado de potencia, que incluye la bater'ia, el circuito de carga y el circuito que alimenta motores, switch y la placa SecurePi. Conexionado de alimentaci'on de l'ogica, circuito regulado a 5V que alimenta la Raspberry Pi, el punto de acceso WiFi y la placa SensorPi. Conexionado de sensores y por 'ultimo el conexionado de datos.\\
